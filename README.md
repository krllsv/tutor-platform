...
- Управление преподавателями (Tutors)
- Управление студентами (Students)
- Управление предметами (Subjects)
- Бронирование занятий (Bookings)
- Отзывы о преподавателях (Reviews)
- Асинхронное повышение ставок с отслеживанием прогресса
- Демонстрация race condition и потокобезопасных счётчиков
...
| Java | 21 |
| Spring Boot | 4.0.3 |
| Spring Web / Validation / Data JPA / AOP | - |
| PostgreSQL | 17 |
| Maven | 3.9+ |
| Lombok | 1.18.42 |
